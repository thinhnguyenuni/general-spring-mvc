		...
		<div class="p-4">
			<form:form id="inputForm"
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<form:input path="id" type="text" class="form-control col"
							id="inputID" placeholder="Mã máy (MMxxx)" autocomplete="off" />
						<form:errors path="id" />
				...
				<div class="form-group row mt-3">
					<form:label path="location" for="inputLocation"
						class="col-sm-2 col-form-label">Vị trí</form:label>
					<div class="col-sm-10">
						<form:input path="location" type="text" class="form-control"
							id="inputLocation" placeholder="Vị trí" autocomplete="off" />
						<form:errors path="location" />
						<div class="error text-danger" id="errorLocation"></div>
					</div>
				</div>
				
				<div class="form-group row mt-3">
					<label for="inputStatus" class="col-sm-2 col-form-label">Trạng
						thái</label>
					<div class="col-sm-10">
						<form:input path="status" type="text" class="form-control"
							id="inputStatus" placeholder="Trạng thái" autocomplete="off" />
						<form:errors path="status" />
						<div class="error text-danger" id="errorStatus"></div>
					</div>
				</div>
