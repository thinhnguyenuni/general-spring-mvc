	...
	<div class="col-md-6">
		...
		<div class="col-12 d-flex justify-content-center">
			<a href="${pageContext.request.contextPath}/computer/create"
				class="btn btn-success">Tạo mới máy</a>
		</div>
		<div class="col-12">
			...
			<table id="listComputerTable"
				...
				<tbody>
					<!-- Sử dụng vòng lặp forEach để duyệt qua danh sách các máy tính -->
					<c:forEach var="computer" items="${computers}" varStatus="status">
						<tr>
							...
							<td>
								<!-- Nút chỉnh sửa và nút xóa cho mỗi máy tính --> <a
								href="update?id=${computer.id}"><i
									class="fas fa-edit text-success mx-3"></i></a>
								<button type="button" class="btn" data-bs-toggle="modal"
									data-bs-target="#computer${computer.id}">
									<i class="fas fa-trash-alt text-danger"></i>
								</button> <!-- Modal xác nhận xóa máy tính -->
								<div class="modal fade" id="computer${computer.id}"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<!-- Hiển thị thông báo xác nhận xóa máy tính -->
												Bạn có muốn xóa máy tính <span class="text-danger">${computer.id}</span>
												này không ?
											</div>
											<div class="modal-footer">
												...
												<!-- Nút xác nhận xóa -->
												<a href="delete/${computer.id}" class="btn btn-danger">Có</a>
											</div>
										</div>
									</div>
								</div>
				...
				<c:forEach begin="1" end="${totalPages}" var="i">
					<c:choose>
						...
						<c:when test="${pageNumber eq i}">
							<li class="page-item"><a class="page-link active text-white">${i}</a>
							</li>
						</c:when>
